...
export async function resetDb(sql: Sql): Promise<void> {
  await sql`truncate announcements, subscriptions, delivery_ledger, audit_log, channel_settings, alert_state, publishers, templates, rate_limits restart identity`;
}
